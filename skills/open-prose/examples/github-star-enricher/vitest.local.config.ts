...
// Local, scoped tier-2 gate for the `github-star-enricher` example. Mirrors the
...
//     skills/open-prose/examples/github-star-enricher/vitest.local.config.ts
//
...
export default defineConfig({
  ...
  test: {
    environment: "node",
    include: ["skills/open-prose/examples/github-star-enricher/github-star-enricher.test.ts"],
