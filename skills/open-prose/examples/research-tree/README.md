...
13-node / 20-edge topology is what the reference harness's per-entity expansion
produces from them (see the Harnesses section of the repository README). Below
is one harness's replay layout;
