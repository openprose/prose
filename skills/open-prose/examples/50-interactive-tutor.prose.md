...
Demonstrates how Contract Markdown handles interactive input. `### Requires` collects inputs at system start. Mid-system prompts should use `gate()` when available.
