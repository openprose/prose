...
describe("command model", () => {
	const supportedCases: Array<[Parameters<typeof canonicalPrompt>, string]> = [
		...
		[["write", ["draft a release readiness responsibility"]], "prose run std/ops/prose-author -- request: 'draft a release readiness responsibility'"],
		[["write", ["--", "--no-interactive is literal request text"]], "prose run std/ops/prose-author -- request: '--no-interactive is literal request text'"],
