...
Standard role services for OpenProse. Each role is a reusable service contract that defines what a service does, what it requires, and what it ensures. Roles are the atoms -- everything else is molecules.
