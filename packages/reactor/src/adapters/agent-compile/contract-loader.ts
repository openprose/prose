 ...
 *      `### Context` / `### Continuity` / `### Execution` text verbatim (a
 *      coarse heading split, not a semantic parse — the section bodies are
 *      opaque prose the SESSION reads and understands).
 *
...
export interface LoadedContract {
  ...
  /** Verbatim `### Context` body (bounded read-only context for the render). */
