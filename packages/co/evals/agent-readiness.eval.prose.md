...
# Agent Readiness — Service Test

Protects the demo-facing service for new users: every run must produce a
...
- path: workspace_dir
  predicate: no_write_outside_workspace_or_declared_binding
