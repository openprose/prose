...
test('flat-tokens example source declares npm run example', async () => {
  ...
  assert.equal(packageJson.dependencies['@openprose/reactor'], '0.1.0');
  assert.equal(packageJson.dependencies['@openprose/reactor-cradle'], '0.1.0');
});
