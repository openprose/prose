...
### Phase 5 — Self-check & commit

Before finalizing, run a quick check: does the candidate answer actually satisfy the problem's stated constraints? Is the format exactly what was asked (matching brackets, delimiters, key names, order)? If something fails, revise before emitting.
