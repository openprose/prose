...
mutable current pointers. RFC 014 remains the example backpressure suite.
Historical restructuring plans, launch checklists, and implementation journals
now live in `/Users/sl/code/openprose/planning/archive`.
