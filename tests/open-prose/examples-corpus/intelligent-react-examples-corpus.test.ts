...
// 13 reconciler-substrate examples authored to the validity contract. Their
// deterministic ledger-replay suites live with the reference harness at
// github.com/openprose/reactor; this file guards only the Markdown corpus.
//
...
// The shipped Intelligent-React examples. KEEP THIS LIST IN LOCKSTEP with the
// examples whose replay suites run green in the reference harness's offline
// gate (openprose/reactor, tests/open-prose/examples/**). Partial/WIP examples
